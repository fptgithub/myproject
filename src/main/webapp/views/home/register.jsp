		...
		<div class="container">
			...
			<div class="col-lg-6 mx-auto">
					<div class="login_form_inner">
						...
						<form:form class="row login_form" action="/account/register" method="POST" id="contactForm"   modelAttribute="registerObject" >
							<div class="col-md-12 form-group">
								<form:input class="form-control" path="username"  placeholder="Username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'"/>
