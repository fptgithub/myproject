	...
	<section class="owl-carousel active-product-area section_gap">
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<div class="row">
					<c:forEach var = "p" items="${ latestproduct }">
					<!-- single product -->
					<div class="col-lg-3 col-md-6 border">
						<div class="single-product">
							<img class="img-fluid" src="${ p.poster }" alt="${ p.name }">
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<div class="row">
				<c:forEach var = "p" items="${ comingproduct }">
					<!-- single product -->
					<div class="col-lg-3 col-md-6 border">
						<div class="single-product">
							<img class="img-fluid" src="${ p.poster }" alt="${ p.name }">
		...
		<div class="container-fluid">
			<div class="row justify-content-center align-items-center">
				...
				<div class="col-lg-6 no-padding exclusive-right">
					...
					<c:forEach var = "p" items = "${ exclusiveProduct }">
						...
						<div class="single-exclusive-slider">
							...
							<div class="product-details">
								...
								<div class="add-bag d-flex align-items-center justify-content-center">
									<button class="add-btn add-bag_button" href="" onclick="this.parentNode.submit()"><span class="ti-bag"></span></button>
									<span class="add-text text-uppercase">Add to Bag</span>
								</div>
							</div>
						</div>
